...
const translations = {
  en: {
    ...
    "features.f3.title": "Go for Walks", "features.f3.desc": "Take your pet outside to explore new scenes and props.",
    "features.f4.title": "Chat with Voice", "features.f4.desc": "Talk to your pet, tell it you love it, and hear how it responds.",
    "features.f5.title": "Toys & Outfits", "features.f5.desc": "Buy new toys and looks to build a one-of-a-kind pet.",
    "features.f6.title": "Snap & Share", "features.f6.desc": "Use AR to bring your pet into the real world for a photo.",
  ...
  zh: {
    ...
    "features.f3.title": "外出散步", "features.f3.desc": "带宠物出门遛弯，探索新的场景和道具。",
    "features.f4.title": "语音聊天", "features.f4.desc": "和宠物对话，告诉它你爱它，听听它怎么回应。",
    "features.f5.title": "玩具与装扮", "features.f5.desc": "购买新玩具和造型，打造专属的宠物形象。",
    "features.f6.title": "拍照分享", "features.f6.desc": "用AR技术把宠物“带到”现实场景中拍照留念。",
    "pets.title": "宠物图鉴",
